...
class FahrenheitToCelsius : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonConvertForFahrenheitToCelsius: Button = findViewById(R.id.convertButtonForFahrenheit)
    ...
    private fun fahrenheitToCelsius() {
        val fahrenheit = findViewById<EditText>(R.id.editTextForFahrenheit).getText().toString()
